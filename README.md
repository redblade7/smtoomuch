...
YKYWTMSMW Fortunes for Linux v6.31-preview8

Created by redblade7 (aka redneonglow)

* v6.31-preview8 released on October 1, 2018
...
(6) There are 6503 fortunes (plus 133 offensive ones) in these files which, depending on the amount of fortunes you have installed, might make the likelihood of receiving a YKYWTMSMW fortune higher than you want. If you want to change this behavior, see the fortune man page about the "-e" option.
