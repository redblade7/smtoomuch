...
YKYWTMSMW Fortunes for Linux v6.33-preview1

Created by redblade7 (aka redneonglow)

* v6.33-preview1 released on February 27, 2020
* v6.32 released on February 20, 2020
...
(6) There are 6712 fortunes (plus 146 offensive ones) in these files which, depending on the amount of fortunes you have installed, might make the likelihood of receiving a YKYWTMSMW fortune higher than you want. If you want to change this behavior, see the fortune man page about the "-e" option.
