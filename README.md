...
YKYWTMSMW Fortunes for Linux v6.31-preview5

Created by redblade7 (aka redneonglow)

* v6.31-preview5 released on September 26, 2018
...
(6) There are 6524 fortunes (plus 126 offensive ones) in these files which, depending on the amount of fortunes you have installed, might make the likelihood of receiving a YKYWTMSMW fortune higher than you want. If you want to change this behavior, see the fortune man page about the "-e" option.
