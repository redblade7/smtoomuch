...
YKYWTMSMW Fortunes for Linux v6.31-preview11

Created by redblade7 (aka redneonglow)

* v6.31-preview11 released on December 5, 2018
...
(6) There are 6706 fortunes (plus 145 offensive ones) in these files which, depending on the amount of fortunes you have installed, might make the likelihood of receiving a YKYWTMSMW fortune higher than you want. If you want to change this behavior, see the fortune man page about the "-e" option.
